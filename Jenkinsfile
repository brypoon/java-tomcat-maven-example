                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        removePrefix: 'target/',
                                        remoteDirectory: '/tmp',
                                        execCommand: 'sudo su && systemctl stop tomcat && rm -rf /opt/tomcat/latest/webapps/java-tomcat-maven-example && unzip /tmp/java-tomcat-maven-example.war -d /opt/tomcat/latest/webapps && sudo systemctl start tomcat'
                                    )
                                ]
                            )
                        ]
